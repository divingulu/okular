...
class SettingsPrivate
{
  public:
    ...
    SettingsCore::ItemString *itemTtsVoice;
    ...
    SettingsCore::ItemBool *itemDragBeyondScreenEdges;
...
class SettingsHelper
{
  public:
    ...
    ~SettingsHelper() { delete q; q = nullptr; }
  ...
  : SettingsCore( std::move( config ) )
{
  ...
  d->itemTtsVoice = new SettingsCore::ItemString( currentGroup(), QStringLiteral( "ttsVoice" ), d->ttsVoice );
  addItem( d->itemTtsVoice, QStringLiteral( "ttsVoice" ) );
  ...
  d->itemDragBeyondScreenEdges = new SettingsCore::ItemBool( currentGroup(), QStringLiteral( "DragBeyondScreenEdges" ), d->dragBeyondScreenEdges, true );
  addItem( d->itemDragBeyondScreenEdges, QStringLiteral( "DragBeyondScreenEdges" ) );
...
void Settings::setBuiltinAnnotationTools( const QStringList & v )
{
    if (v != self()->d->builtinAnnotationTools && !self()->Settings::isBuiltinAnnotationToolsImmutable()) {
      ...
      self()->d->settingsChanged.insert(signalBuiltinAnnotationToolsChanged);
    }
}
...
void Settings::setQuickAnnotationTools( const QStringList & v )
{
    if (v != self()->d->quickAnnotationTools && !self()->Settings::isQuickAnnotationToolsImmutable()) {
      ...
      self()->d->settingsChanged.insert(signalQuickAnnotationToolsChanged);
    }
}
...
void Settings::setTtsVoice( const QString & v )
{
    if (!self()->Settings::isTtsVoiceImmutable())
      self()->d->ttsVoice = v;
}

QString Settings::ttsVoice()
{
  return self()->d->ttsVoice;
}

bool  Settings::isTtsVoiceImmutable()
{
    return self()->isImmutable( QStringLiteral( "ttsVoice" ) );
}
...
void Settings::setViewContinuous( bool v )
{
    if (v != self()->d->viewContinuous && !self()->Settings::isViewContinuousImmutable()) {
      ...
      self()->d->settingsChanged.insert(signalViewContinuousChanged);
    }
}
...
void Settings::setDragBeyondScreenEdges( bool v )
{
    if (!self()->Settings::isDragBeyondScreenEdgesImmutable())
      self()->d->dragBeyondScreenEdges = v;
}

bool Settings::dragBeyondScreenEdges()
{
  return self()->d->dragBeyondScreenEdges;
}

bool  Settings::isDragBeyondScreenEdgesImmutable()
{
    return self()->isImmutable( QStringLiteral( "DragBeyondScreenEdges" ) );
}
...
void Settings::setPrimaryAnnotationToolBar( int v )
{
    if (v != self()->d->primaryAnnotationToolBar && !self()->Settings::isPrimaryAnnotationToolBarImmutable()) {
      ...
      self()->d->settingsChanged.insert(signalPrimaryAnnotationToolBarChanged);
    }
}
...
void Settings::setRecolorForeground( const QColor & v )
{
    if (v != self()->d->recolorForeground && !self()->Settings::isRecolorForegroundImmutable()) {
      ...
      self()->d->settingsChanged.insert(signalColorModesChanged2);
    }
}
...
{
  delete d;
  if (s_globalSettings.exists() && !s_globalSettings.isDestroyed()) {
...
bool Settings::usrSave()
{
  ...
  if (d->settingsChanged.contains(signalBuiltinAnnotationToolsChanged))
    Q_EMIT builtinAnnotationToolsChanged();
  if (d->settingsChanged.contains(signalQuickAnnotationToolsChanged))
    Q_EMIT quickAnnotationToolsChanged();
  if (d->settingsChanged.contains(signalViewContinuousChanged))
    Q_EMIT viewContinuousChanged();
  if (d->settingsChanged.contains(signalColorModesChanged2))
    Q_EMIT colorModesChanged2();
  if (d->settingsChanged.contains(signalPrimaryAnnotationToolBarChanged))
    Q_EMIT primaryAnnotationToolBarChanged();
  d->settingsChanged.clear();
  return true;
}

void Settings::itemChanged(quint64 signalFlag) {
  d->settingsChanged.insert(signalFlag);
